...
import { Key, Database, Settings, Unlock } from 'lucide-react';
  ...
  return (
    <div style={{ height: '100%', overflowY: 'auto', padding: '24px 28px' }}>
      <div style={{ marginBottom: 24 }}>
        <h2 style={{ margin: 0, fontSize: 20, fontWeight: 700, color: '#e2e8f0' }}>Admin</h2>
      ...
      <div style={{
        ...
        <Unlock size={14} style={{ color: '#60a5fa', flexShrink: 0, marginTop: 2 }} />
        <div>
          ...
          <div style={{ fontSize: 12, color: 'rgba(255,255,255,0.5)', lineHeight: 1.5 }}>
            ...
            Auth is scaffolded in <code style={{ fontSize: 11, color: 'rgba(255,255,255,0.6)' }}>src/lib/supabaseClient.js</code> — enable via <code style={{ fontSize: 11, color: 'rgba(255,255,255,0.6)' }}>DEV_AUTH=false</code> when ready.
          </div>
        </div>
      </div>
          ...
          return (
            <div key={section.title} style={{
              ...
              <div style={{
                ...
                <SIcon size={14} style={{ color: 'rgba(255,255,255,0.5)', flexShrink: 0 }} />
                <span style={{ fontSize: 14, fontWeight: 600, color: '#e2e8f0' }}>{section.title}</span>
              </div>
      ...
      <div style={{
        ...
        <span>Set environment variables via <code style={{ color: 'rgba(255,255,255,0.5)' }}>.env.local</code> (local dev) or Vercel project settings (production). See <code style={{ color: 'rgba(255,255,255,0.5)' }}>.env.sample</code> for the full reference.</span>
      </div>
    </div>
  );
}
